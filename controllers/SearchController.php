<?php 
	...
	class SearchController extends Controller{
		...
		public function searchall(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("SearchAllView.php",["data"=>$data,"numPage"=>$numPage,"fromPrice"=>$fromPrice,"toPrice"=>$toPrice,"keyid"=>$keyid,"keytype"=>$keytype,"keyline"=>$keyline,"keystatus"=>$keystatus,"keycolor"=>$keycolor ]);
		}
	}
?>